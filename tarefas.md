# *AVALIAÇÕES DO PROJETO – CRONOGRAMA E ENTREGAS*
...
- Nome do projeto
- Link do GitHub do projeto (no README)
- Integrantes do grupo

**Link da planilha:**
https://docs.google.com/spreadsheets/d/1bSb1-S9qOf46fNH8quyoFpcjcTuBMj_EdSPchOuFULY

### *No projeto (README ou documento)*
- Item 1: Descrição do projeto
- Item 2: Situação problema (cenário)
- Item 3: Descrição da proposta
...
> *Observação:* Nesta etapa, não é necessário ter tudo pronto. Apenas o que for referente aos cadastros básicos já é suficiente.
...
- Link da publicação do backend (Render ou similar)
- Link da publicação do frontend (Vercel ou similar)

### *Requisitos*
- Telas básicas de cadastros simples
- Frontend consumindo o backend de forma funcional
